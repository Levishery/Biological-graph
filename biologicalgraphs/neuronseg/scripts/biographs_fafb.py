...
# dataIO.WriteH5File(mapping['original'],'/braindat/lab/liusl/flywire/biologicalgraphs/biologicalgraphs/neuronseg/features/biological/edges-600nm-18x52x52/testing/unknowns/'+prefix+'mapping.h5', 'original', compression=True)
#
